 ...
 */
@FunctionalInterface
public interface HBaseCellParserOld<R> {
    /**
     * Dummy cell parser that always returns {@code false}
     */
    HBaseCellParserOld<Object> DUMMY = (result, column, value) -> false;
    ...
    static <R> HBaseCellParserOld<R> dummy() {
        return (HBaseCellParserOld<R>) DUMMY;
    }
     ...
     */
    static <R, C, V> HBaseCellParserOld<R> hBaseCellParser(TriConsumer<R, C, V> setter,
