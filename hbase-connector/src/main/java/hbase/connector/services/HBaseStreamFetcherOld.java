...
public class HBaseStreamFetcherOld {
    private static final Logger LOGGER = LoggerFactory.getLogger(HBaseStreamFetcherOld.class);
    private final HBaseConnectorOld connector;

    public HBaseStreamFetcherOld(HBaseConnectorOld connector) {
